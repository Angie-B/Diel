...
errors <- aq.data %>%
     ...
     mutate(Area = Area/2)
aq.data.fixed$Area[(aq.data$Replicate.Name=="160701_Smp_6R1") &
                  (aq.data$Compound.Name=="D-Phenylalanine"|
                 aq.data$Compound.Name=="Vitamin B2_IS")
             ] <- errors$Area
...
errors <- aq.data %>%
     ...
     mutate(Area = Area/2)
aq.data.fixed$Area[(aq.data$Replicate.Name=="160701_Smp_5R1") &
                  (aq.data$Compound.Name=="D-Tryptophan"|
                 aq.data$Compound.Name=="d-IAA"|
                      aq.data$Compound.Name=="d4-Tryptamine")
             ] <- errors$Area
```
