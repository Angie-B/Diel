...
```{r areaCorrect}
new.data <- full_join(aq.data.sub, volData)
new.data <- new.data %>% 
...
##Write rsd data
```{r eval=FALSE}
write.csv(rsd.plot.data2, "Cyano_Aq_diel_1_normalization_rsd_allDat_blkSub.csv")
...
```{r}
write.csv(dat.join.aq, "Cyano_Aq_diel_1_Samples_Normalized_BlkSub_2IS.csv")
```
