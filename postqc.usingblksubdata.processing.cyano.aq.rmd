...
##If the compounds were found in less than 25% of samples, discard the data
...
##Write rsd data
```{r eval=FALSE}
write.csv(rsd.plot.data2, "Cyano_Aq_diel_1_normalization_rsd_allDat_blkSub_backfill.csv")
write.csv(rsd.plot.data.dcm2, "Cyano_dcm_diel_1_normalization_rsd_allDat_blkSub_backfill.csv")
```
...
```{r}
write.csv(dat.join.aq, "Cyano_Aq_diel_1_Samples_Normalized_BlkSub_backfill_2IS.csv")
dat.join.aq.noblk <- dat.join.aq %>% 
     filter(type!="Blk")
write.csv(dat.join.aq.noblk, "Cyano_Aq_diel_1_Samples_Normalized_BlkSub_backfill_2IS_noblk.csv")

write.csv(dat.join.dcm, "Cyano_DCM_diel_1_Samples_Normalized_BlkSub_backfill_2IS.csv")
```
