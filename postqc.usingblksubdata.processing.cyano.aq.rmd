...
#                                        yes=`Vitamin B2_IS.Norm.Area`,
#                                       no=ifelse(PooPlusModel.IS==
#                                             "D8-Arachiodonic Acid.Norm.Area",
#                            yes=`D8-Arachiodonic Acid.Norm.Area`,no = NA))))
...
write.csv(rsd.plot.data.dcm2, "Cyano_dcm_diel_1_normalization_rsd_allDat_blkSub_backfill_new0926.csv")
```
...
write.csv(dat.join.dcm, "Cyano_DCM_diel_1_Samples_Normalized_BlkSub_backfill_2IS_new0926.csv")
dat.join.dcm.noblk <- dat.join.dcm %>% filter(type!="Blk")
write.csv(dat.join.dcm.noblk, "Cyano_DCM_diel_1_Samples_Normalized_BlkSub_backfill_2IS_noblk_new0926.csv")
```
