...
##read in data
```{r}
dat.join.aq <- read_csv("Cyano_Aq_diel_1_Samples_Normalized_BlkSub_2IS_noblk.csv")
...
q <- ggplot(samp.dat.means, aes(x=SampID, y=meanArea)) + geom_point() + geom_line() +   facet_wrap(~Compound.Name, scales = "free") 
